...
9. **Accessibility from first deployment** (ADR-003) — WCAG 2.1 AA. Mobile-first responsive design. Semantic HTML, keyboard navigation, 44×44px touch targets. Performance for 3G in rural India.
